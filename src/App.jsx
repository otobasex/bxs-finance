    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mover-card { background: #FDF8F5; border: 1px solid var(--cream-border); border-radius: var(--r-xl); padding: 22px 22px 20px; display: flex; flex-direction: column; gap: 6px; position: relative; transition: transform 0.2s, box-shadow 0.2s; }
        .mover-card:hover { transform: translateY(-1px); box-shadow: 0 6px 18px rgba(13,11,9,0.06); }
        .mover-icon { position: absolute; top: 14px; right: 14px; width: 30px; height: 30px; border-radius: 8px; display: flex; align-items: center; justify-content: center; }
